...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(app)/app/app` | `/app/app` | `/(app)/app/list` | `/app/list` | `/(app)/client/addressOptions` | `/client/addressOptions` | `/(app)/client/client` | `/client/client` | `/(app)/client/contactOptions` | `/client/contactOptions` | `/(app)/client/list` | `/client/list` | `/(app)/dashboard` | `/dashboard` | `/(app)/projects/list` | `/projects/list` | `/(app)/projects/project` | `/projects/project` | `/(app)/website/list` | `/website/list` | `/(app)/website/options` | `/website/options` | `/(app)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/(tabs)/login` | `/login` | `/(tabs)/register` | `/register` | `/(tabs)/_layout` | `/+html` | `/appsModal` | `/createModal` | `/entityView` | `/modal`;
  // prettier-ignore
